...
__author__ = 'Mr-YOUSAFF'
__copyright = 'All rights reserved . Copyright  Mr-YOUSAFF'
...
\033[1;97m--------------------------------------------------
\033[1;94m➤\033[1;97m Author : Mr-YOUSAFF
...
def reg():
    ...
    except (KeyError, IOYOUSAFF):
        reg2()

    r = requests.get('https://raw.githubusercontent.com/YOUSAF/Mr-YOUSAFF/main/server.txt').text
    if to in r:
...
def log_menu_s():
    ...
    if s == '1':
        ...
        os.system('xdg-open https://https://www.facebook.com/profile.php?id=100005679279353/')
    else:
        print ''
...
def log_fb():
    ...
    try:
        ...
        if 'loc' in q:
            ...
            ts.close()
            menu()
        elif 'www.facebook.com' in q['YOUSAFF']:
...
def menu_s():
    ms = raw_input('\033[1;97m╰─Mr-YOUSAFF➤ ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \033[1;97m╰─Mr-YOUSAFF➤ ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\033[1;92mMr-YOUSAFF Father Of Facebook\033[1;94m'
    print 47 * '-'
